<div class="sidebar d-flex flex-column" id="sidebar">
    ...
    <nav class="nav flex-column mt-2">
        ...
        <!---MENSAJE
        <a class="nav-link <?php echo e(request()->is('compras/mensajeria') ? 'active' : ''); ?>" href="<?php echo e(url('compras/mensajeria')); ?>">
...
<?php /**PATH C:\xampp\htdocs\Proveedores\resources\views/includes/sidebar/compras.blade.php ENDPATH**/ ?>