...
<?php $__env->startSection('title', 'Cita No Programada'); ?>
...
<?php endif; ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/rol/almacen/cita-no-programada.css')); ?>">
    ...
    <div class="container-fluid con-sidebar">
        <div class="container">
            <form id="citaForm" method="POST" action="<?php echo e(route('almacen.citas.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.movil', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Proveedores\resources\views/pages/almacen/CitaNoProgramado.blade.php ENDPATH**/ ?>