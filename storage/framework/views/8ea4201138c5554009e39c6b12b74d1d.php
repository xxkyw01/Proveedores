<div class="sidebar d-flex flex-column" id="sidebar">
    ...
    <nav class="nav flex-column mt-2">
        ...
        <!---MENSAJE
        <a class="nav-link <?php echo e(request()->is('mejora/mensajeria') ? 'active' : ''); ?>" href="<?php echo e(url('mejora/mensajeria')); ?>">
...
<?php /**PATH C:\xampp\htdocs\Proveedores\resources\views/includes/sidebar/auditoria.blade.php ENDPATH**/ ?>