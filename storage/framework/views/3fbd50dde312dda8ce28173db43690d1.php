...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('includes.scripts.Socketio', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/rol/socket/mensajeria.css')); ?>">
            ...
            <div class="modal-content shadow">
                ...
                <div class="modal-body" style="max-height: 60vh; overflow-y: auto;">
                    ...
                    <ul id="lista-usuarios" class="list-group mb-4">
                        <?php $__currentLoopData = $contactos->where('tipo', 'U'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item contacto d-flex justify-content-between align-items-center"
                                data-id="<?php echo e($c->id); ?>" data-tipo="U" data-nombre="<?php echo e(strtolower($c->Nombre)); ?>">
                                <div><i class="bi bi-person-circle me-2 text-primary"></i><?php echo e($c->Nombre); ?></div>
                    ...
                    <ul id="lista-proveedores" class="list-group">
                        <?php $__currentLoopData = $contactos->where('tipo', 'P'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item contacto d-flex justify-content-between align-items-center"
                                data-id="<?php echo e($c->id); ?>" data-tipo="P" data-nombre="<?php echo e(strtolower($c->Nombre)); ?>">
                                <div><i class="bi bi-truck me-2 text-warning"></i><?php echo e($c->Nombre); ?></div>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    <span class="text-muted" id="totalContactos">Total: <?php echo e(count($contactos)); ?>

                        contacto<?php echo e(count($contactos) !== 1 ? 's' : ''); ?></span>
    ...
    <script>
        const rutaBase = '<?php echo e(url()->current()); ?>'.split('/mensajeria')[0];
        const remitenteTipo = '<?php echo e($es_proveedor ? 'P' : 'U'); ?>';
        const remitenteId = '<?php echo e($es_proveedor ? session('Proveedor.id') : session('Usuario.IdUsuario')); ?>';
...
<?php echo $__env->make('layouts.movil', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Proveedores\resources\views/pages/mensajeria/index.blade.php ENDPATH**/ ?>