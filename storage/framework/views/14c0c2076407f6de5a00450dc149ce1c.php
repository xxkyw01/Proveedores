...
<?php $__env->startSection('title', 'Recibo de mercancía'); ?>
...
<?php endif; ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/rol/almacen/grpo.css')); ?>">
            ...
            <div class="detallesCompras col-lg-4 col-md-5 left-panel"
                ...
                <div class="mb-4 d-flex align-items-center justify-content-between">
                    ...
                    <?php if(!in_array($rolId, [2])): ?>
                        <form method="GET" action="<?php echo e(route('almacen.reciboMercancia')); ?>" class="mb-0">
                            <select name="sucursal_id" id="sucursal_id" class="form-select form-select-sm"
                                ...
                                <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>"
                                        <?php echo e(request('sucursal_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->nombre); ?>
    ...
    <div class="modal fade" id="modalAgregarOC" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Agregar Orden(es) de Compra</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
    ...
    <script>
        const SESSION_USER = <?php echo json_encode([
            'id' => session('Usuario.IdUsuario') ?? (session('Usuario.id') ?? null), 'username' => session('Usuario.Usuario') ?? (session('Usuario.user') ?? (session('Usuario.nombre') ?? 'N/A')), ]) ?>;
        ...
        const SERIES_BY_SUC = <?php echo json_encode(config('sap_series.grpo_series_by_sucursal'), 15, 512) ?>;
        ...
        function loadOrdenes() {
            const sucursalId = document.getElementById('sucursal_id')?.value || '<?php echo e($sucursal_id ?? 0); ?>';
...
<?php echo $__env->make('layouts.movil', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Proveedores\resources\views/pages/almacen/ReciboMercancia.blade.php ENDPATH**/ ?>