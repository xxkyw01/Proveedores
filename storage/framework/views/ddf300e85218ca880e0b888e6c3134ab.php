<div class="sidebar d-flex flex-column" id="sidebar">
    ...
    <nav class="nav flex-column mt-2">
        <a class="nav-link <?php echo e(request()->is('proveedor/dashboard') ? 'active' : ''); ?>"
            href="<?php echo e(url('proveedor/dashboard')); ?>">
            <i class="fas fa-home nav-icon"></i><span class="nav-text">Inicio</span>
        </a>

        <!--Mensajeria
        <a class="nav-link <?php echo e(request()->is('proveedor/mensajeria') ? 'active' : ''); ?>" href="<?php echo e(url('proveedor/mensajeria')); ?>">
...
<?php /**PATH C:\xampp\htdocs\Proveedores\resources\views/includes/sidebar/proveedor.blade.php ENDPATH**/ ?>