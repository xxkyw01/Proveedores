<div class="sidebar d-flex flex-column" id="sidebar">
        ...
        <nav class="nav flex-column mt-2">
            <!---INICIO-->
            <a class="nav-link <?php echo e(request()->is('dev/dashboard') ? 'active' : ''); ?>" href="<?php echo e(url('dev/dashboard')); ?>">
                <i class="fas fa-home nav-icon"></i><span class="nav-text">Inicio</span>
            </a>
            <!---MENSAJE
            <a class="nav-link <?php echo e(request()->is('dev/mensajeria') ? 'active' : ''); ?>" href="<?php echo e(url('dev/mensajeria')); ?>">
            ...
            <div class="accordion" id="accordionSidebar">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseDesarrollador" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            <a class="nav-link <?php echo e(request()->is('dev/crear-usuario') ? 'active' : ''); ?>"
                                href="<?php echo e(url('dev/crear-usuario')); ?>">
                                <i class="fas fa-user-plus nav-icon"></i><span class="nav-text"> Crear Usuario</span>
                            </a>
                            <a class="nav-link <?php echo e(request()->is('dev/usuarios') ? 'active' : ''); ?>"
                                href="<?php echo e(url('dev/usuarios')); ?>">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseProveedor" class="accordion-collapse collapse" aria-labelledby="headingProveedor"
                        ...
                        <div class="accordion-body">
                            <a class="nav-link <?php echo e(request()->is('proveedor/citas') ? 'active' : ''); ?>"
                                href="<?php echo e(url('proveedor/citas')); ?>">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseCompras" class="accordion-collapse collapse" aria-labelledby="headingCompras"
                        data-bs-parent="#accordionSidebar">
                        <div class="accordion-body">
                            <a class="nav-link <?php echo e(request()->is('reporte/maniobras') ? 'active' : ''); ?>"
                                href="<?php echo e(route('reporte.maniobras')); ?>">
...
<?php /**PATH C:\xampp\htdocs\Proveedores\resources\views/includes/sidebar/dev.blade.php ENDPATH**/ ?>