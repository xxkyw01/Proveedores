...
<?php $__env->startSection('content'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/rol/proveedor/historial.css')); ?>">
                    ...
                    <div class="row row-cols-2 row-cols-md-5 g-2 text-center">
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($totalCitas); ?></h5>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasPendientes); ?></h5>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasConfirmadas); ?></h5>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasCanceladas); ?></h5>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasAsistio ?? 0); ?></h5>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasNoAsistio ?? 0); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasEnProceso ?? 0); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h6 class="text-uppercase fw-bold text-muted mb-0" style="font-size: 0.8rem;">Recepción
                                    tardía</h6>
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasRecepcionTardia ?? 0); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h6 class="text-uppercase fw-bold text-muted mb-0" style="font-size: 0.8rem;">Cancelada por
                                    proveedor</h6>
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasCanceladasPorProveedor ?? 0); ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-0 p-2"
                                ...
                                <h5 class="fw-bold text-dark mb-0"><?php echo e($citasNoProgramado ?? 0); ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="tablaReservas" class="table table-striped table-bordered align-middle">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $reservaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reserva): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e(\Carbon\Carbon::parse($reserva->fecha)->format('d/m/Y')); ?>

                                            <br>
                                            <?php echo e(\Carbon\Carbon::parse($reserva->hora)->format('h:i A')); ?>

                                        </td>
                                        <td><?php echo e($reserva->proveedor_nombre); ?></td>
                                        <td><?php echo nl2br(e($reserva->ordenes_detalle ?? '-')); ?></td>
                                        <td><?php echo e($reserva->sucursal_nombre ?? 'N/A'); ?></td>
                                        <td>
                                            <?php
...
<?php echo $__env->make('layouts.movil', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ygonzalez\Synology\Home\Escritorio\Proveedores\resources\views/pages/proveedor/historial.blade.php ENDPATH**/ ?>