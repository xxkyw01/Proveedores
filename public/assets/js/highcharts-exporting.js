            ...
            class B {
                ...
                open() {
                    ...
                    p(c, "fullscreenOpen", null, function () {
                        b &&
                            ((a.origWidthOption = b.width),
                            (a.origHeightOption = b.height));
                        ...
                        if (a.browserProps) {
                            ...
                            const m =
                                c.renderTo[a.browserProps.requestFullscreen]();
                            if (m)
                                m["catch"](function () {
                                    alert(
                ...
                setButtonText() {
                    ...
                    m &&
                        ...
                        a.setElementHTML(
                            ...
                            this.isOpen
                                ? b.exitFullscreen
                                : m.menuItemDefinitions.viewFullscreen.text ||
                                      b.viewFullscreen
                        );
                }
                toggle() {
                ...
                function F(a) {
                    ...
                    if (!1 !== b.enabled && b.theme) {
                        ...
                        var r = d
                            ...
                            .attr({
                                title: q(
                                    f.options.lang[b._titleKey || b.titleKey],
                                    ""
                                ),
                            });
                        r.menuClassName =
                            a.menuClassName ||
                            "highcharts-menu-" + f.btnCount++;
                        b.symbol &&
                            ((x = d
                                .symbol(
                                    b.symbol,
                ...
                function Y(b, f, c, e, g, E, n) {
                    ...
                    h ||
                        ...
                        f.forEach(function (b) {
                            "string" === typeof b &&
                                (b =
                                    d.options.exporting.menuItemDefinitions[b]);
                            if (T(b, !0)) {
                                let f;
                                b.separator
                                    ...
                                    : ("viewData" === b.textKey &&
                                      ...
                                      a.setElementHTML(
                                          f,
                                          b.text || d.options.lang[b.textKey]
                                      ),
                                      d.styledMode ||
                ...
                function da(a) {
                    ...
                    this.axes.forEach(function (a) {
                        a.userOptions.internalKey ||
                            (a.userOptions.internalKey = W());
                        a.options.isInternal ||
                            (n[a.coll] || ((n[a.coll] = !0), (d[a.coll] = [])),
                            d[a.coll].push(
                                k(a.userOptions, { visible: a.visible })
                            ));
                    });
                ...
                function ea(a, b) {
                    ...
                    return this.getSVG(
                        k({ chart: { borderRadius: 0 } }, d.chartOptions, b, {
                            exporting: {
                                sourceWidth:
                                    (a && a.sourceWidth) || d.sourceWidth,
                                sourceHeight:
                                    (a && a.sourceHeight) || d.sourceHeight,
                            },
                        })
                    );
                }
                ...
                function ha() {
                    function a(d) {
                        ...
                        if (
                            ...
                            w(d, f);
                            "svg" === d.nodeName &&
                                d.setAttribute("stroke-width", "1px");
                            "text" !== d.nodeName &&
