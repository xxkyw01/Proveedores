...
!(function (t, e) {
    ...
    const a = "swal2-",
        ...
        ct = (t) => {
            ...
            if (st())
                return void m("SweetAlert2 requires document to initialize");
        ...
        jt = (t) => {
            ...
            return (
                ...
                t.progressStepsDistance &&
                    J(e, "width", t.progressStepsDistance),
                e
            );
        },
        It = (t, e) => {
    ...
    const se = (t) => {
            t.isAwaitingPromise &&
                ...
                r.innerParams.get(t) || t._destroy());
        },
        re = (t) =>
            void 0 === t
    ...
    const Ye = (t) => {
        ...
        return (
            Object.keys(t).forEach((n) => {
                _e(n)
                    ? (e[n] = t[n])
                    : p("Invalid parameter to update: ".concat(n));
            }),
            e
        );
    };
    ...
    class jn {
        ...
        _main(t) {
            ...
            ((t) => {
                ...
                i.currentInstance &&
                    (i.currentInstance._destroy(), N() && Yt()),
