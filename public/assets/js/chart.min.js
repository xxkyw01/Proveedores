...
!(function (t, e) {
    ...
    const Ne = (t, e) =>
        !0 === t ? e : "string" == typeof t ? y(e, t) : void 0;
    ...
    class Ls {
        ...
        applyStack(t, e, i) {
            const s = this.chart,
                ...
                o = e[t.axis];
            return Ms(
                { keys: ws(s, !0), values: e._stacks[t.axis] },
                o,
                n.index,
                { mode: i }
            );
        ...
        getMinMax(t, e) {
            const i = this._cachedMeta,
                ...
                l = ((t, e, i) =>
                    t &&
                    !e.hidden &&
                    e._stacked && { keys: ws(i, !0), values: null })(
                    e,
                    i,
                    this.chart
                ),
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                f.$shared &&
                    ((f.$shared = r), (n[o] = Object.freeze(Ts(f, r)))),
                f
            );
        }
    ...
    class Ys {
        ...
        unregister(t) {
            ...
            i in e && delete e[i],
                s &&
                    i in ne[s] &&
                    (delete ne[s][i], this.override && delete te[i]);
        }
    }
    var Us = new (class {
        constructor() {
    ...
    const rn = (t) =>
        n(t) &&
        Object.getOwnPropertyNames(t).reduce((e, i) => e || k(t[i]), !1);
            ...
            e &&
                ...
                d(n, (e) => {
                    const n = e.options,
                        ...
                        l = r(n.type, e.dtype);
                    (void 0 !== n.position &&
                        hn(n.position, a) === hn(e.dposition)) ||
            ...
            e.fullCircles &&
                (function (t, e, i) {
                    ...
                    for (
                        ...
                        t.stroke();
                    for (
                        t.beginPath(), t.arc(s, n, l, o, o + O), c = 0;
                        c < r;
                        ++c
                    )
                        t.stroke();
    ...
    class to extends Es {
        ...
        get segments() {
            return (
                this._segments ||
                (this._segments = Di(this, this.options.segment))
            );
        }
        first() {
            ...
            inner: {
                ...
                radius: {
                    ...
                    bottomRight: Math.max(
                        0,
                        a.bottomRight - Math.max(o.b, o.r)
                    ),
                },
            },
        };
    ...
    function ao(t, e, i, s) {
        const n = null === e,
            ...
            a = t && !(n && o) && so(t, s);
        return (
            a && (n || Q(e, a.left, a.right)) && (o || Q(i, a.top, a.bottom))
        );
    }
    function ro(t, e) {
                ...
                l.setWidth(this.width),
                    x
                        ? w > 0 &&
                          ...
                          g.line++,
                          (P = g.x =
                              ut(n, this.left + d, this.right - i[g.line])))
                        : w > 0 &&
                          D + y > this.bottom &&
        ...
        _getLegendItemAt(t, e) {
            ...
            if (Q(t, this.left, this.right) && Q(e, this.top, this.bottom))
                for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                    if (
                        ((s = n[i]),
                        Q(t, s.left, s.left + s.width) &&
                            Q(e, s.top, s.top + s.height))
                    )
    ...
    class Go extends Es {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = No(a, Wo(s))), (a = No(a, Wo(n))), (a = No(a, Wo(o))), a
            );
        }
        getBeforeBody(t, e) {
            ...
            const n = (function (t, e) {
                ...
                for (
                    ...
                    (u && w !== a
                        ? (s.push({ value: a }),
                          w < a && D++,
                          N(Math.round((w + D * S) * v) / v, a, ea(a, y, t)) &&
                              D++)
                        : w < a && D++);
                    D < k;
                    ++D
            ...
            return (
                ...
                null === t || isNaN(t)
                    ...
                    : this.getPixelForDecimal(
                          t === this.min
                              ? 0
                              : (I(t) - this._startValue) / this._valueRange
                      )
            );
        }
        getValueForPixel(t) {
                    ...
                    this.ticks.forEach((t, e) => {
                        if (0 !== e) {
                            ...
                            !(function (t, e, i, s) {
                                ...
                                this,
                                n.setContext(this.getContext(e - 1)),
                                r,
                                o
                            );
                        }
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (
                                  let e = ma.indexOf(t) + 1, i = ma.length;
                                  e < i;
                                  ++e
                              )
