...
!(function (t, e) {
  ...
  function q() {
    return new TransformStream({
      transform: function (t, e) {
        !(function (t, e) {
          k && t.data instanceof Blob
            ? t.data.arrayBuffer().then(E).then(e)
            : w && (t.data instanceof ArrayBuffer || _(t.data))
            ? e(E(t.data))
            : A(t, !1, function (t) {
  ...
  function rt() {}
  var it = null != new nt({ xdomain: !1 }).responseType,
    ot = (function (t) {
      o(s, t);
      var n = l(s);
      function s(t) {
  ...
  var ut =
    ...
    pt = { websocket: ft, webtransport: lt, polling: ot },
    dt =
  ...
  function Et(t) {
    var e = [],
      ...
      r = t;
    return (
      (r.data = Tt(n, e)), (r.attachments = e.length), { packet: r, buffers: e }
    );
  }
  function Tt(e, n) {
    if (!e) return e;
            ...
            value: function (t, e) {
              ...
              return (
                n
                  ...
                  : ((n = new Ut(this, t, e)), (this.nsps[t] = n)),
                n
              );
            },
          },
  ...
  return i(Vt, { Manager: Ft, Socket: Ut, io: Vt, connect: Vt }), Vt;
});
