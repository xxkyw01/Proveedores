    ...
    b(
        ...
        function (a, b, e, p, n, C, r) {
            function c() {
                ...
                O(
                    P(a, "text/csv") ||
                        "data:text/csv,\ufeff" + encodeURIComponent(a),
            ...
            function ba(b) {
                var c =
                    (b = v(b, !this.isDataTableVisible)) && !this.dataTableDiv;
                c &&
            ...
            function ea() {
                ...
                if (
                    b &&
                    a.options.exporting &&
                    a.options.exporting.allowTableSorting
                ) {
