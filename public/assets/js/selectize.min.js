...
(function (root, factory) {
    ...
    var highlight = function (t, e) {
                ...
                (o.plugins = {}),
                    (o.prototype.initializePlugins = function (t) {
                        ...
                        if (
                            ...
                            for (e = 0, n = t.length; e < n; e++)
                                "string" == typeof t[e]
                                    ? s.push(t[e])
                                    : ((o.plugins.settings[t[e].name] =
                                          t[e].options),
                                      s.push(t[e].name));
                        else if (t)
                            for (i in t)
                                t.hasOwnProperty(i) &&
                                    ((o.plugins.settings[i] = t[i]), s.push(i));
                    ...
                    (o.prototype.loadPlugin = function (t) {
                        var e = this,
                            n = e.plugins,
                            i = o.plugins[t];
                        if (!o.plugins.hasOwnProperty(t))
                            throw new Error(
                                'Unable to find "' + t + '" plugin'
                            );
                        (n.requested[t] = !0),
                            (n.loaded[t] = i.fn.apply(e, [
                                e.plugins.settings[t] || {},
                            ])),
                            n.names.push(t);
                    }),
        ...
        cmp =
            ((Sifter.prototype.tokenize = function (t, e) {
                if (!(t = trim(String(t || "").toLowerCase())) || !t.length)
                    return [];
                for (
                    var n, i, o = [], s = t.split(/ +/), r = 0, a = s.length;
                    r < a;
                    r++
                ) {
                    if (((n = escape_regex(s[r])), this.settings.diacritics))
                        for (i in DIACRITICS)
                            DIACRITICS.hasOwnProperty(i) &&
                                (n = n.replace(
                                    new RegExp(i, "g"),
                                    DIACRITICS[i]
                                ));
                    e && (n = "\\b" + n),
                        o.push({ string: s[r], regex: new RegExp(n, "i") });
                }
                return o;
            }),
            ...
            (Sifter.prototype.getSortFunction = function (t, n) {
                var e,
                    ...
                    p = this,
                    c =
                        (!(t = p.prepareSearch(t, n)).query && n.sort_empty) ||
                        n.sort,
                    u = function (t, e) {
                        return "$score" === t
                            ? e.score
                            : getattr(p.items[e.id], t, n.nesting);
                    },
                    d = [];
                if (c)
            ...
            (Sifter.prototype.search = function (t, n) {
                ...
                return (
                    ...
                    "number" == typeof n.limit &&
                        (s.items = s.items.slice(0, n.limit)),
                    s
                );
            }),
            function (t, e) {
                return "number" == typeof t && "number" == typeof e
                    ? e < t
                        ...
                        ? -1
                        : 0
                    : ((t = asciifold(String(t || ""))),
                      (e = asciifold(String(e || ""))) < t
                          ? 1
                          : t < e
                          ? -1
                          : 0);
        ...
        asciifold = (function () {
            ...
            for (n in DIACRITICS)
                if (DIACRITICS.hasOwnProperty(n))
                    for (
                        o += i =
                            DIACRITICS[n].substring(
                                2,
                                DIACRITICS[n].length - 1
                            ),
                            t = 0,
                            e = i.length;
                        t < e;
    ...
    var IS_MAC = uaDetect("macOS", /Mac/),
                        ...
                        t.type &&
                            ...
                            i === KEY_DELETE || i === KEY_BACKSPACE
                                ? (o = getInputSelection(s[0])).length
                                    ? (e =
                                          e.substring(0, o.start) +
                                          e.substring(o.start + o.length))
                                    : i === KEY_BACKSPACE && o.start
                                    ? (e =
                                          e.substring(0, o.start - 1) +
                                          e.substring(o.start + 1))
                                    : i === KEY_DELETE &&
                                      void 0 !== o.start &&
                                      (e =
                                          e.substring(0, o.start) +
        ...
        Selectize = function (t, e) {
            ...
            if (
                ...
                $.extend(o, {
                    ...
                    onSearchChange:
                        null === e.loadThrottle
                            ? o.onSearchChange
                            : debounce(o.onSearchChange, e.loadThrottle),
                }),
            ...
            (o.settings.mode =
                o.settings.mode ||
                (1 === o.settings.maxItems ? "single" : "multi")),
                "boolean" != typeof o.settings.hideSelected &&
                    (o.settings.hideSelected = "multi" === o.settings.mode),
    ...
    MicroEvent.mixin(Selectize),
        ...
        $.extend(Selectize.prototype, {
                ...
                var e = this,
                    ...
                    d =
                        ...
                        e.plugins.names.length &&
                            ((d = "plugin-" + e.plugins.names.join(" plugin-")),
                            l.addClass(d),
                            r.addClass(d)),
                        (null === t.maxItems || 1 < t.maxItems) &&
                            e.tagType === TAG_SELECT &&
                            s.attr("multiple", "multiple"),
                        e.settings.placeholder &&
                            c.attr("placeholder", t.placeholder),
                        e.settings.search ||
                            (c.attr("readonly", !0),
                            c.attr("inputmode", "none"),
                            p.css("cursor", "pointer")),
                        !e.settings.splitOn &&
                            e.settings.delimiter &&
                            ((a = e.settings.delimiter.replace(
                                /[-\/\\^$*+?.()|[\]{}]/g,
                                "\\$&"
                            )),
                            (e.settings.splitOn = new RegExp(
                                "\\s*" + a + "+\\s*"
                            ))),
                        s.attr("autocorrect") &&
                            c.attr("autocorrect", s.attr("autocorrect")),
                        s.attr("autocapitalize") &&
                            c.attr("autocapitalize", s.attr("autocapitalize")),
                        ...
                        o.on("keydown" + n, function (t) {
                            (e.isCmdDown = t[IS_MAC ? "metaKey" : "ctrlKey"]),
                                (e.isCtrlDown =
                                    t[IS_MAC ? "altKey" : "ctrlKey"]),
                                (e.isShiftDown = t.shiftKey);
                        }),
                        o.on("keyup" + n, function (t) {
                            t.keyCode === KEY_CTRL && (e.isCtrlDown = !1),
                                t.keyCode === KEY_SHIFT && (e.isShiftDown = !1),
                                t.keyCode === KEY_CMD && (e.isCmdDown = !1);
                        }),
                        o.on("mousedown" + n, function (t) {
                            if (e.isFocused) {
                                if (
                                    t.target === e.$dropdown[0] ||
                                    t.target.parentNode === e.$dropdown[0]
                                )
                                    return !1;
                                e.$dropdown.has(t.target).length ||
                                    t.target === e.$control[0] ||
                                    e.blur(t.target);
                            }
                        }),
                        i.on(
                            ...
                            function () {
                                e.isOpen &&
                                    e.positionDropdown.apply(e, arguments);
                            }
                        ),
                    ...
                    return (
                        "single" === e.settings.mode
                            ...
                            : (n || e.setActiveItem(null),
                              e.settings.openOnFocus ||
                                  (e.isOpen && t.target === e.lastOpenTarget
                                      ? (e.close(), (e.lastOpenTarget = !1))
                                      : (e.isOpen ||
                                            (e.refreshOptions(), e.open()),
                                        (e.lastOpenTarget = t.target)))),
                        !1
                    );
            },
            onChange: function () {
                    ...
                    : o.settings.splitOn &&
                      setTimeout(function () {
                          ...
                          if (t.match(o.settings.splitOn))
                              for (
                                  var e = t.trim().split(o.settings.splitOn),
                                      n = 0,
                                      i = e.length;
                                  n < i;
                                  n++
            ...
            onKeyPress: function (t) {
                ...
                return this.isLocked
                    ? t && t.preventDefault()
                    : ((e = String.fromCharCode(t.keyCode || t.which)),
            ...
            onKeyDown: function (t) {
                ...
                if (n.isLocked) t.keyCode !== KEY_TAB && t.preventDefault();
                    ...
                    switch (t.keyCode) {
                        ...
                        case KEY_DOWN:
                            return (
                                !n.isOpen && n.hasOptions
                                    ? n.open()
                                    : n.$activeOption &&
                                      ((n.ignoreHover = !0),
                                      (e = n.getAdjacentOption(
                                          n.$activeOption,
                                          1
                                      )).length) &&
                                      n.setActiveOption(e, !0, !0),
                        ...
                        case KEY_TAB:
                            return (
                                n.settings.selectOnTab &&
                                    n.isOpen &&
                                    n.$activeOption &&
                                    (n.onOptionSelect({
                                        currentTarget: n.$activeOption,
                                    }),
                                    n.isFull() || t.preventDefault()),
                                void (
                                    n.settings.create &&
                                    n.createItem() &&
                                    n.settings.showAddOptionOnCreate &&
                                    t.preventDefault()
                                )
                            );
                        case KEY_BACKSPACE:
                    ...
                    (!n.isFull() && !n.isInputHidden) ||
                        (IS_MAC ? t.metaKey : t.ctrlKey) ||
                        t.preventDefault();
                }
            },
            onInput: function (t) {
                        ...
                        : void 0 !== (e = e.attr("data-value")) &&
                          ...
                          n.settings.closeAfterSelect
                              ...
                              : !n.settings.hideSelected &&
                                t.type &&
                                /mouse/.test(t.type) &&
                                n.setActiveOption(n.getOption(e)));
            },
                    ...
                    t.apply(e, [
                        function (t) {
                            (e.loading = Math.max(e.loading - 1, 0)),
                                ...
                                e.loading ||
                                    n.removeClass(e.settings.loadingClass),
                                e.trigger("load", t);
                        },
                    ]);
            },
            ...
            getValue: function () {
                return this.tagType === TAG_SELECT &&
            ...
            setMaxItems: function (t) {
                (this.settings.maxItems = t = 0 === t ? null : t),
                    (this.settings.mode =
                        this.settings.mode ||
            ...
            setActiveItem: function (t, e) {
                ...
                if ("single" !== l.settings.mode)
                    if ((t = $(t)).length) {
                        if (
                            "mousedown" === (n = e && e.type.toLowerCase()) &&
                            l.isShiftDown &&
                            ...
                            for (
                                ...
                                (s = l.$control[0].childNodes[i]),
                                    -1 === l.$activeItems.indexOf(s) &&
                                        ($(s).addClass("active"),
                                        l.$activeItems.push(s));
                            e.preventDefault();
                        } else
                            ("mousedown" === n && l.isCtrlDown) ||
                            ("keydown" === n && this.isShiftDown)
                                ? t.hasClass("active")
                                    ? ((r = l.$activeItems.indexOf(t[0])),
                                      l.$activeItems.splice(r, 1),
                                      t.removeClass("active"))
                                    : l.$activeItems.push(
                                          t.addClass("active")[0]
                                      )
                                : ($(l.$activeItems).removeClass("active"),
                                  (l.$activeItems = [t.addClass("active")[0]]));
                        l.hideInput(), this.isFocused || l.focus();
                    } else
                        $(l.$activeItems).removeClass("active"),
                            (l.$activeItems = []),
                            l.isFocused && l.showInput();
            },
            setActiveOption: function (t, e, n) {
                var i,
                    ...
                    a = this;
                a.$activeOption &&
                    (a.$activeOption.removeClass("active"),
                    a.trigger(
                        "dropdown_item_deactivate",
                        a.$activeOption.attr("data-value")
                    )),
                    (a.$activeOption = null),
                    (t = $(t)).length &&
                        ...
                        (!e && isset(e)) ||
                            ...
                            (r =
                                (s = o =
                                    a.$activeOption.offset().top -
                                    a.$dropdown_content.offset().top +
                                    e) -
                                t +
                                i),
                            t + e < o + i
            ...
            selectAll: function () {
                ...
                "single" !== t.settings.mode &&
                    ((t.$activeItems = Array.prototype.slice.apply(
                        t.$control.children(":not(input)").addClass("active")
                    )),
                    t.$activeItems.length && (t.hideInput(), t.close()),
                    t.focus());
            },
            hideInput: function () {
            ...
            blur: function (t) {
                return (
                    this.$control_input[0].blur(), this.onBlur(null, t), this
                );
            },
            ...
            search: function (t) {
                ...
                if (
                    s.score &&
                    "function" != typeof (i = o.settings.score.apply(this, [t]))
                )
                    throw new Error(
                    ...
                    (t !== o.lastQuery
                        ? (s.normalize &&
                              (t = t
                                  ...
                                  .replace(/[\u0300-\u036f]/g, "")),
                          (o.lastQuery = t),
                          (n = o.sifter.search(t, $.extend(r, { score: i }))),
                          (o.currentResults = n))
                        : (n = $.extend(!0, {}, o.currentResults)),
                    s.hideSelected)
                )
                    for (e = n.items.length - 1; 0 <= e; e--)
                        -1 !== o.items.indexOf(hash_key(n.items[e].id)) &&
                            n.items.splice(e, 1);
                return n;
            },
            refreshOptions: function (t) {
                ...
                var e,
                    ...
                    y =
                        g.$activeOption &&
                        hash_key(g.$activeOption.attr("data-value")),
                    w = v.items.length;
                for (
                    ...
                    for (
                        r = g.options[v.items[e].id],
                            a = g.render("option", r),
                            O = r[g.settings.optgroupField] || "",
                            n = 0,
                            i = (l = Array.isArray(O) ? O : [O]) && l.length;
                        n < i;
                        n++
                    ) {
                        var C,
                            O = l[n];
                        g.optgroups.hasOwnProperty(O) ||
                            "function" !=
                                typeof g.settings.optionGroupRegister ||
                            ((C = g.settings.optionGroupRegister.apply(g, [
                                O,
                            ])) &&
                                g.registerOptionGroup(C)),
                            g.optgroups.hasOwnProperty(O) || (O = ""),
                            o.hasOwnProperty(O) ||
                                ((o[O] = document.createDocumentFragment()),
                                s.push(O)),
                            o[O].appendChild(a);
                    }
                for (
                    this.settings.lockOptgroupOrder &&
                        s.sort(function (t, e) {
                            return (
                                ((g.optgroups[t] && g.optgroups[t].$order) ||
                                    0) -
                    ...
                    g.optgroups.hasOwnProperty((O = s[e])) &&
                    o[O].childNodes.length
                        ? ((c = document.createDocumentFragment()).appendChild(
                              g.render("optgroup_header", g.optgroups[O])
                          ),
                          c.appendChild(o[O]),
                          p.appendChild(
                              g.render(
                                  "optgroup",
                                  $.extend({}, g.optgroups[O], {
                                      html: domToString(c),
                                      dom: c,
                                  })
                              )
                ...
                if (
                    ...
                    g.settings.highlight &&
                        (m.removeHighlight(), v.query.length) &&
                        v.tokens.length)
                )
                    for (e = 0, w = v.tokens.length; e < w; e++)
                        highlight(m, v.tokens[e].regex);
                if (!g.settings.hideSelected)
                    for (
                        g.$dropdown.find(".selected").removeClass("selected"),
                            e = 0,
                            w = g.items.length;
                        e < w;
                        e++
                ...
                "auto" !== g.settings.dropdownSize.sizeType &&
                    g.isOpen &&
                    g.setupDropdownHeight(),
                    (u = g.canCreate(f)) &&
                        g.settings.showAddOptionOnCreate &&
                        (m.prepend(g.render("option_create", { input: f })),
                        (h = $(m[0].childNodes[0]))),
                    (g.hasOptions =
                        0 < v.items.length ||
                        (u && g.settings.showAddOptionOnCreate) ||
                        g.settings.setFirstOptionActive),
                    g.hasOptions
                        ? (0 < v.items.length
                              ? ((f = y && g.getOption(y)),
                                "" !== v.query &&
                                g.settings.setFirstOptionActive
                                    ...
                                    : "single" === g.settings.mode &&
                                      g.items.length &&
                                      (d = g.getOption(g.items[0])),
                                (d && d.length) ||
                                    (d =
                                        h && !g.settings.addPrecedence
                                            ? g.getAdjacentOption(h, 1)
                                            : m.find(
            ...
            updateOption: function (t, e) {
                ...
                if (
                    ((t = hash_key(t)),
                    (n = hash_key(e[s.settings.valueField])),
                    null !== t && s.options.hasOwnProperty(t))
                ) {
                    if ("string" != typeof n)
                    ...
                    (o = s.options[t].$order),
                        n !== t &&
                            (delete s.options[t],
                            -1 !== (i = s.items.indexOf(t))) &&
                            s.items.splice(i, 1, n),
                        (e.$order = e.$order || o),
                        (s.options[n] = e),
            ...
            addItems: function (t, e) {
                ...
                for (
                    var n = this.$control[0].childNodes, i = 0;
                    i < n.length;
                    i++
                )
                    this.buffer.appendChild(n[i]);
                for (
                    var o = Array.isArray(t) ? t : [t], i = 0, s = o.length;
                    i < s;
                    i++
                )
                ...
                (t = hash_key(s.attr("data-value"))),
                    -1 !== (n = o.items.indexOf(t)) &&
                        ...
                        s.hasClass("active") &&
                            ...
                            (i = o.$activeItems.indexOf(s[0])),
                            o.$activeItems.splice(i, 1),
                            s.removeClass("active")),
                        o.items.splice(n, 1),
                        (o.lastQuery = null),
                        !o.settings.persist &&
                            o.userOptions.hasOwnProperty(t) &&
                            o.removeOption(t, e),
                ...
                var e =
                        "function" == typeof i.settings.create
                            ...
                            : function (t) {
                                  ...
                                  if (
                                      !i.settings.formatValueToKey ||
                                      "function" !=
                                          typeof i.settings.formatValueToKey ||
                                      (null !=
                                          (t =
                                              i.settings.formatValueToKey.apply(
                                                  this,
                                                  [t]
                                              )) &&
                                          "object" != typeof t &&
                    ...
                    r = once(function (t) {
                        ...
                        return (
                            ...
                            "object" != typeof t ||
                            "string" !=
                                typeof (e = hash_key(t[i.settings.valueField]))
                                ? s()
                                : (i.setTextboxValue(""),
                                  i.addOption(t),
                                  i.setCaret(o),
            ...
            refreshItems: function (t) {
                (this.lastQuery = null),
                    this.isSetup && this.addItem(this.items, t),
                    this.refreshState(),
                    ...
                    a.tagType === TAG_SELECT
                        ? ((o = a.$input.find("option")),
                          ...
                          a.items.forEach(function (t) {
                              (s = a.options[t][a.settings.labelField] || ""),
                                  r.push(t),
                                  -1 == e.indexOf(t) &&
                                      n.push(
                                          '<option value="' +
                          ...
                          e.length - i.length + n.length !== 0 ||
                              a.$input.attr("multiple") ||
                              n.push(
            ...
            close: function () {
                ...
                "single" === t.settings.mode &&
                    t.items.length &&
                    (t.hideInput(), t.isBlurring) &&
                    t.$control_input[0].blur(),
                    (t.isOpen = !1),
                    t.$dropdown.hide(),
            ...
            positionDropdown: function () {
                ...
                this.settings.minWidth &&
                    ...
                    this.$dropdown.css({ width: t, top: e.top, left: e.left });
            },
            ...
            insertAtCaret: function (t) {
                ...
                0 === e
                    ...
                    : n.insertBefore(t, n.childNodes[e]),
                    this.setCaret(e + 1);
            },
            deleteSelection: function (t) {
                ...
                if (
                    (r.$activeOption &&
                        ...
                        (o = (
                            "string" == typeof r.settings.deselectBehavior &&
                            "top" === r.settings.deselectBehavior
                                ? r.getFirstOption()
                                : r.getAdjacentOption(r.$activeOption, -1)
                        ).attr("data-value")),
                    (i = []),
                    r.$activeItems.length)
                ) {
                    for (
                        s = r.$control.children(
                            ".active:" + (0 < a ? "last" : "first")
                        ),
                            s = r.$control.children(":not(input)").index(s),
                            0 < a && s++,
                            e = 0,
                            n = r.$activeItems.length;
                        e < n;
                        e++
                    )
                    ...
                    (r.isFocused || "single" === r.settings.mode) &&
                        r.items.length &&
                        (a < 0 && 0 === l.start && 0 === l.length
                            ? i.push(r.items[r.caretPos - 1])
                            : 0 < a &&
                              l.start === r.$control_input.val().length &&
                              i.push(r.items[r.caretPos]));
                if (
                    !i.length ||
                    ("function" == typeof r.settings.onDelete &&
                        !1 === r.settings.onDelete.apply(r, [i]))
                )
                    return !1;
                ...
                return (
                    ...
                    r.positionDropdown(),
                    r.refreshOptions(!0),
                    o && (t = r.getOption(o)).length && r.setActiveOption(t),
                    !0
                );
            },
            advanceSelection: function (t, e) {
                ...
                0 !== t &&
                    ...
                    s.isFocused && !s.isInputHidden
                        ? ((i = s.$control_input.val().length),
                          (t < 0
                              ? 0 !== o.start || 0 !== o.length
                              : o.start !== i) ||
                              i ||
                              s.advanceCaret(t, e))
                        : (o = s.$control.children(".active:" + n)).length &&
                          ((i = s.$control.children(":not(input)").index(o)),
                          s.setActiveItem(null),
                          s.setCaret(0 < t ? i + 1 : i)));
            },
            advanceCaret: function (t, e) {
                ...
                0 !== t &&
                    (i.isShiftDown
                        ? (n = i.$control_input[0 < t ? "next" : "prev"]())
                              .length &&
                          (i.hideInput(), i.setActiveItem(n), e) &&
                          e.preventDefault()
            ...
            setCaret: function (t) {
                ...
                if (
                    ((t =
                        "single" === e.settings.mode
                            ? e.items.length
                            : Math.max(0, Math.min(e.items.length, t))),
                    !e.isPending)
                )
                    for (
                        var n,
                            i = e.$control.children(":not(input)"),
                            o = 0,
                            s = i.length;
                        o < s;
                        o++
            ...
            render: function (t, e) {
                ...
                return (s =
                    "option" !== t && "item" !== t
                        ? s
                        : !!(n = hash_key(e[r.settings.valueField]))) &&
                    (isset(r.renderCache[t]) || (r.renderCache[t] = {}),
                    r.renderCache[t].hasOwnProperty(n))
                    ? r.renderCache[t][n]
                    : ((o = $(
                          r.settings.render[t].apply(this, [e, escape_html])
                      )),
                      "option" === t || "option_create" === t
                          ? e[r.settings.disabledField] ||
                            o.attr("data-selectable", "")
                          : "optgroup" === t &&
                            ((i = e[r.settings.optgroupValueField] || ""),
                            o.attr("data-group", i),
                            e[r.settings.disabledField]) &&
                            o.attr("data-disabled", ""),
                      ("option" !== t && "item" !== t) ||
                          o.attr("data-value", n || ""),
            ...
            clearCache: function (t) {
                void 0 === t
                    ? (this.renderCache = {})
                    : delete this.renderCache[t];
            },
            canCreate: function (t) {
                var e;
                return (
                    !!this.settings.create &&
                    ((e = this.settings.createFilter), t.length) &&
        ...
        ($.fn.selectize = function (c) {
            function u(t, o) {
                ...
                for (
                    o.maxItems = t.attr("multiple") ? null : 1,
                        n = 0,
                        i = (r = t.children()).length;
                    n < i;
                    n++
                )
                ...
                if (!this.selectize) {
                    var t = $(this),
                        ...
                        i =
                            (n ||
                                v.allowEmptyOption ||
                                (n = t.children('option[value=""]').text()),
                            v.allowEmptyOption &&
                                v.showEmptyOptionInDropdown &&
                                !t.children('option[value=""]').length &&
                                ((l = t.html()),
                                (i = escape_html(v.emptyOptionLabel || "--")),
                                t.html(
                                    '<option value="">' + i + "</option>" + l
                                )),
                            {
                                placeholder: n,
                                options: [],
                    ...
                    if ("select" === e) u(t, i);
                        ...
                        if (n)
                            ...
                            if (v.allowEmptyOption || n.length) {
                                for (
                                    o = 0,
                                        s = (r = n.split(v.delimiter)).length;
                                    o < s;
                                    o++
                                )
                                    ((a = {})[y] = r[o]),
                    ...
                    new Selectize(t, $.extend(!0, {}, d, i, c)).settings_user =
                        c;
                }
            });
        }),
        ...
        Selectize.define("auto_position", function () {
            ...
            this.positionDropdown = function () {
                var t = this.$control,
                    ...
                    n =
                        ((e.top += t.outerHeight(!0)),
                        this.$dropdown.prop("scrollHeight") + 5),
                    n =
                ...
                n === o.top
                    ...
                    : (Object.assign(i, { top: e.top, bottom: "unset" }),
                ...
                function (t) {
                    ...
                    return (
                        void 0 !== e.attr("data-value") &&
                            i.getValue() !== e.attr("data-value") &&
                            i.setValue(e.attr("data-value")),
                    ...
                    function () {
                        t.apply(n, arguments),
                            ...
                            n.on("change", function () {
                                "" === n.getValue() || 0 === n.getValue().length
                                    ? n.$wrapper
                                          .find("." + e.className)
                                          .css("display", "none")
                                    : n.$wrapper
        ...
        Selectize.define("optgroup_columns", function (r) {
            function t() {
                ...
                if (s && a.$dropdown_content.width()) {
                    ...
                    r.equalizeWidth &&
                        ((i = a.$dropdown_content.innerWidth() - l()),
                        (n = Math.round(i / s)),
                        o.css({ width: n }),
                        1 < s) &&
                        ((i = i - n * (s - 1)), o.eq(s - 1).css({ width: i }));
                }
            }
            var i,
                a = this,
                        ...
                        function (t) {
                            ...
                            (a.ignoreHover = !0),
                                ...
                                (n = (n = (n =
                                    t.keyCode === KEY_LEFT
                                        ? n.prev("[data-group]")
                                        : n.next("[data-group]")).find(
                                    "[data-selectable]"
                                )).eq(Math.min(n.length - 1, e))).length &&
            ...
            (r.equalizeHeight || r.equalizeWidth) &&
                (hook.after(this, "positionDropdown", t),
                hook.after(this, "refreshOptions", t));
        }),
                ...
                (this.onKeyDown =
                    ...
                    function (t) {
                        ...
                        if (
                            ...
                            return i.apply(this, arguments);
                        (e = this.options[this.items[e]]),
                            this.deleteSelection(t) &&
                                (this.setTextboxValue(n.text.apply(this, [e])),
                    ...
                    return (
                        ...
                        setTimeout(function () {
                            i.settings.selectOnTab &&
                                i.setActiveOption(
                                    i.getFirstItemMatchedByTextContent(e)
                                ),
