  ...
  <table>
    ...
    <tr>
      <td class="hero">
        ...
        <p><strong>Proveedor:</strong> {{ $proveedor->Nombre_Proveedor }}</p>
        <p><strong>Código:</strong> {{ $proveedor->Codigo_Proveedor ?? 'N/A' }}</p>
        <p><strong>Correo Registrado:</strong> {{ $proveedor->Correo_Electronico ?? 'No registrado' }}</p>
