...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/rol/almacen/monitorAgenda.css') }}">
    ...
    <div class="container-fluid c">
        <div class="row justify-content-center">
            <div class="d-flex flex-wrap justify-content-center align-items-center gap-3 flex-column flex-md-row">
                @if (!in_array($rolId, [8]))
                    <form method="GET" action="{{ route('agenda.index') }}" class="m-0">
    ...
    <script>
        ...
        function loadAgendaDataForDate(date, index) {
            ...
            if (!sucursalId) sucursalId = @json($sucursalIdUsuario);
